  ...
  return (
    <div className={styles.video}>
      <div className={styles.videoWrap}>
        <div
          ref={toTargets}
          className={`${styles.videoPlayer} ${animated.slideRight}`}
        >
          <iframe
            width="100%"
            height="100%"
        ...
        <div
          ref={toTargets}
          className={`${styles.videoContent} ${animated.slideLeft}`}
        >
          <h3 className={styles.videoTtl}>ゼクサマーケットとは</h3>
          <p className={styles.videoTxt}>
            texttexttexttexttexttexttexttexttexttext
            texttexttexttexttexttexttexttexttexttext
            texttexttexttexttexttexttexttexttexttext texttext
          </p>
        </div>
      </div>
    </div>
